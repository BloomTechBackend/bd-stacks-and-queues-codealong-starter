 ...
 * closing curly brace, '}'. Additional checks will be added at a later date.
 */
public class AmazonJavaFileCompiler {

    private final List<Character> fileChars;
     ...
     * @return true if the file passes all compilation checks, false otherwise
     */
